...
enum tTecla{ ARRIBA, IZQUIERDA, DERECHA, ESPACIO, ENTER, ABAJO, OTRA}; // usado para leer teclas especiales
const std::string SIMBOLOS = "^<>~"; //simbolos a mostrar al pulsar las cuatro primeras teclas
